  ...
  return (
    <div className="portfolio-setting-container">
      {setting ? (
        ...
        <p>No portfolio settings available</p>
      )}
      <div><p></p></div>
      {setting && (
        <div className="portfolio-button-container">
          ...
          <button className="portfolio-button" onClick={handleSaveButtonClick}>
            Save
          </button>
          <div className="button-space"></div>
          <button className="portfolio-button" onClick={handleResetButtonClick}>
            Reset
          </button>
        </div>
      )}
